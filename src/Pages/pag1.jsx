    ...
    <div className="rating">
      ...
      >
        <i
          ...
          style={{ color: nota >= 1 ? "#f8ff00" : "#808080", fontSize: "3em" }}
        ></i>
      </button>
      <button
        onClick={() => setNota(2)}
      ...
      >
        <i
          ...
          style={{ color: nota >= 2 ? "#f8ff00" : "#808080", fontSize: "3em" }}
        ></i>
      </button>
      <button
        onClick={() => setNota(3)}
      ...
      >
        <i
          ...
          style={{ color: nota >= 3 ? "#f8ff00" : "#808080" , fontSize: "3em"}}
        ></i>
      </button>
      <button
        onClick={() => setNota(4)}
      ...
      >
        <i
          ...
          style={{ color: nota >= 4 ? "#f8ff00" : "#808080" , fontSize: "3em"}}
        ></i>
      </button>
      <button
        onClick={() => setNota(5)}
      ...
      >
        <i
          ...
          style={{ color: nota >= 5 ? "#f8ff00" : "#808080", fontSize: "3em" }}
        ></i>
      </button>
      <p>
